        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            delay: 0.35
              ...
              <span className="inline-flex items-center gap-2">100+ already on the waitlist<span className="w-2 h-2 bg-primary rounded-full animate-pulse" />
          ...
          ease: "easeOut"
            ...
            <div className="relative mx-auto max-w-sm lg:max-w-md">
              ...
              duration: 0.5,
              delay: 0.6
            }} className="absolute -left-4 top-1/4 bg-background border-2 border-border rounded-xl px-4 py-2 shadow-lg">
              ...
              duration: 0.5,
              delay: 0.7
            }} className="absolute -right-4 top-1/2 bg-background border-2 border-border rounded-xl px-4 py-2 shadow-lg">
              ...
              duration: 0.5,
              delay: 0.8
            }} className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-primary text-primary-foreground rounded-xl px-4 py-2 shadow-lg">
